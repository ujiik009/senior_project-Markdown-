	...
	function regexMD_to_html(text){
		...
		text.replace(objpatt.pattTableth,"<table border=1>\n<tr>\n\t<th>$1</th>\n\t<th>$2</th>\n\t<th>$3</th>\n</tr>")
			.replace(objpatt.pattUnderline,"<u>$2</u>")
			...
			.replace(/< /gm,"&lt;")
			.replace(objpatt.pattTap3,"<p style='text-indent: 150px;'>$2</p>")
			.replace(objpatt.pattTap2,"<p style='text-indent: 100px;'>$2</p>")
			.replace(objpatt.pattTap1,"<p style='text-indent: 50px;'>$2</p>");
